                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-8">
                        ...
                        <div class="section-about__text box">
                            <h3>About project</h3>
                            <p>This site include search engine, adding, deleting and updating options. Searching search name and isn't case sensitive</p>
                        </div>
                    </div>
				...
				<c:forEach var="tempProduct" items="${products}">
					...
					<tr>
						...
						<td>
							...
							<button href="${deleteLink}" onclick="if (!(confirm('Are you sure you want to delete this product?'))) return false" type="button"
