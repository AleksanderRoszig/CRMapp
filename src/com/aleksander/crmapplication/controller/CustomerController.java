...
import com.aleksander.crmapplication.service.CustomerService;
...
public class CustomerController {
	...
	public String customerDetails(@RequestParam("customerId") int theId) {
		
		// show customer
		customerService.customerDetails(theId);
